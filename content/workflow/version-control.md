...
- Bad: `https://www.khurafat.desi`, `www.khurafat.desi`, `Khurafat.desi`
- Good: `khurafat.desi`

Sites that are hosted on a subdomain may use that subdomain in their name

- Bad: `khurafat.desi-guidelines`
- Good: `guidelines.khurafat.desi`
...
Merging branches via GitHub pull requests are required for pushing code to `master` branch. It is done for the following reasons:

- To have a peer review your changes for any logical issues
- To ensure your branch can be merged and commits can be squashed via an interface
- To allow a quick way to retrieve this point in history by browsing passed pull requests in future
