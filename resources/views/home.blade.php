@component('layouts.app')
    <section class="home">
        <header class="home__header waves">
            <div class="home__header__inner">
                <div class="home__logo">
                    <a href="https://www.khurafat.desi" target="khurafat">
                        @include('svg.logo')
                    </a>
                </div>
        ...
        <section class="home__introduction">
            <p class="-large">
                This site contains a set of guidelines we use to bring our projects to a good end. We documented our workflow because consistency is one of the most valuable traits of maintainable software.
            </p>
            <p>
            ...
            <p>
                All pages are hosted on <a href="{{ config('app.github') }}" target="khurafat">GitHub</a>, so edits and improvements are welcome. Note that these are our own opinionated ideas, so we'll be finicky when it comes to substantial changes.
            </p>
        </section>
